...
| Feeds reviewed | 11 |
| Total articles | 798 |
| Stale articles (>48h) | 647 |
| Scrub pass | ✅ ran |
| Flagged for removal | 16 |
...
|------|----------|-----------|-------------|-------|------------|
| 🤖 AI/ML & Tech | 148 | 🟡 49.6 | 18–65 | 123 | TechRadar (23) |
| 🌍 Climate & Energy | 38 | 🟡 49.0 | 8–80 | 30 | Mother Jones (5) |
| 🏛️ Architecture & Design | 53 | 🔴 41.9 | 18–72 | 47 | ArchDaily (23) |
| 🏠 Homelab & DIY | 43 | 🟡 51.5 | 12–63 | 33 | XDA Developers (11) |
| 🌾 Homestead & Hobby Farm | 12 | 🔴 43.2 | 0–56 | 11 | Hobby Farms (5) |
| 🏔️ Williams Lake Local | 46 | 🟢 72.4 | 40–92 | 29 | My Cariboo Now (19) |
| 📰 General News | 254 | 🟡 63.1 | 22–72 | 216 | NYT Business (22) |
| 🥾 Outdoors & Recreation | 20 | 🔴 34.0 | 8–56 | 14 | Outside Online (8) |
| 🔬 Science | 57 | 🔴 43.0 | 4–60 | 49 | ScienceDaily (11) |
| 🚀 Sci-Fi & Culture | 19 | 🔴 22.3 | 0–50 | 13 | Comments for Solarpunk Magazine (4) |
| 🌿 Health & Wellness | 108 | 🟡 55.1 | 10–77 | 82 | ScienceDaily (14) |
...
### 🗑️ Recommended for Removal (16)

- **[🤖 AI/ML & Tech]** `score 40` — Let ChatGPT, Gemini & more fight for your approval—ChatPlayground is just $60 for lifetime access  
  Issue: `deals`  
  <https://boingboing.net/2026/08/22/let-chatgpt-gemini-more-fight-for-your-approval-chatplayground-is-just-60-for-lifetime-access.html>
- **[🤖 AI/ML & Tech]** `score 40` — List of operas by Carl Maria von Weber  
  Issue: `off-topic`  
  <https://en.wikipedia.org/w/index.php?title=List_of_operas_by_Carl_Maria_von_Weber&diff=1370684653&oldid=1286490729>
- **[🤖 AI/ML & Tech]** `score 40` — Talking Friends  
  Issue: `off-topic`  
  <https://en.wikipedia.org/w/index.php?title=Talking_Friends&diff=1370684612&oldid=1370013332>
- **[🤖 AI/ML & Tech]** `score 22` — 12 celebrities who support AI  
  Issue: `celebrity`  
  <https://www.businessinsider.com/pro-ai-celebrities-investors-companies>
- **[🤖 AI/ML & Tech]** `score 18` — Trump meets boy rescued from drowning, tells him he probably wouldn't have helped  
  Issue: `celebrity`  
  <https://boingboing.net/2026/08/21/trump-lifeguard-rescued-boy.html>
- **[🤖 AI/ML & Tech]** `score 18` — Logitech G Pro X mechanical keyboard price drops by a staggering 39%  
  Issue: `deals`  
  <https://www.neowin.net/deals/logitech-g-pro-x-mechanical-keyboard-price-drops-by-a-staggering-39/?utm_source=rss>
- **[🌍 Climate & Energy]** `score 40` — Nihonmatsu, Fukushima  
  Issue: `off-topic`  
  <https://en.wikipedia.org/w/index.php?title=Nihonmatsu,_Fukushima&diff=1370684626&oldid=1346528745>
- **[🌍 Climate & Energy]** `score 22` — Ferrari just sold a single super-divisive Luce at 62x its asking price  
  Issue: `off-topic`  
  <https://newatlas.com/automotive/ferrari-luce-charity-auction-40-million/>
- **[🏛️ Architecture & Design]** `score 40` — 20th-Century Architecture of Frank Lloyd Wright  
  Issue: `off-topic`  
  <https://en.wikipedia.org/w/index.php?title=20th-Century_Architecture_of_Frank_Lloyd_Wright&diff=1370684656&oldid=1370670156>
- **[🏛️ Architecture & Design]** `score 40` — Behind the Bricks: What Actually Happens During a Professional Chimney Inspection  
  Issue: `off-topic`  
  <https://www.pinuphouses.com/behind-the-bricks-what-actually-happens-during-a-professional-chimney-inspection/>
- **[🏛️ Architecture & Design]** `score 18` — Heinz adjustable ketchup lid allows for "perfect squeeze"  
  Issue: `clickbait`  
  <https://www.dezeen.com/2026/08/21/kraft-heinz-love-lid-ketchup-adjustable/>
- **[🏛️ Architecture & Design]** `score 18` — Photos reveal world's tallest hotel in Dubai  
  Issue: `clickbait`  
  <https://www.dezeen.com/2026/08/21/ciel-dubai-marina-worlds-tallest-hotel/>
- **[🏛️ Architecture & Design]** `score 35` — OpenAI takes a privacy shot at Anthropic with ZDR support for frontier AI models  
  Issue: `off-topic`  
  <https://www.neowin.net/news/openai-takes-a-privacy-shot-at-anthropic-with-zdr-support-for-frontier-ai-models/?utm_source=rss>
- **[🏠 Homelab & DIY]** `score 40` — Achime Bagel Store / JOJOWORKSHOP  
  Issue: `off-topic`  
  <https://www.archdaily.com/1183424/achime-bagel-store-jojoworkshop>
- **[🏠 Homelab & DIY]** `score 20` — Giving Back  
  Issue: `off-topic`  
  <https://www.popularwoodworking.com/editors-blog/giving-back/>
- **[🏠 Homelab & DIY]** `score 30` — Sift Through Grace Baldwin's Giant Junk Drawer Filled with Nostalgia  
  Issue: `clickbait`  
  <https://www.thisiscolossal.com/2026/08/grace-baldwin-giant-junk-drawer-sculpture/>
...
- 🕐 **🤖 AI/ML & Tech** has 123 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
- 🕐 **🌍 Climate & Energy** has 30 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
- 🕐 **🏛️ Architecture & Design** has 47 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🕐 **🏠 Homelab & DIY** has 33 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
- 🕐 **🌾 Homestead & Hobby Farm** has 11 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🕐 **🏔️ Williams Lake Local** has 29 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🕐 **📰 General News** has 216 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🕐 **🥾 Outdoors & Recreation** has 14 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
- 🕐 **🔬 Science** has 49 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🕐 **🚀 Sci-Fi & Culture** has 13 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
- 🕐 **🌿 Health & Wellness** has 82 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
- 🗑️ 16 article(s) should be removed (`off-topic` ×9, `clickbait` ×3, `deals` ×2, `celebrity` ×2) — add matching keywords to `config/filters.json` blocked_keywords to prevent recurrence.

---

_Report generated by `score_scrub_report.py` · 11 feeds · 798 articles · 2026-08-24 03:18 UTC_
