...
**Ratings:** 7 Exemplars, 36 Good, 59 Interesting, 293 Bad, 33 reassigned to day(s), 26 recategorized
**Status:** ✅ config/feedback_examples.txt updated

**Top liked sources:** WIRED (3), Outside Online (2), Engadget (2), ScienceAlert (2), Fast Company (2)
**Top disliked sources:** Rolling Stone (24), Edge (GamesRadar) (20), Ideal Home (Country Homes & Interiors) (20), Outside Online (14), Domino (14)
**Categories liked:** news (11), ai-tech (5), wellness (4), science (3), homestead (3), climate (3), homelab (2), design (2), scifi (1), outdoors (1), local (1)
**Categories disliked:** news (254), wellness (19), ai-tech (6), design (5), homelab (3), outdoors (2), local (2), science (1), scifi (1)

**Day reassignment summary:**
- friday → sunday: 4 articles
- friday → wednesday: 3 articles
- friday → tuesday: 2 articles
- friday → saturday: 2 articles
...
- monday → tuesday: 3 articles
- monday → monday: 1 articles
- monday → wednesday: 1 articles
- monday → thursday: 1 articles
- monday → friday: 1 articles
- monday → saturday: 1 articles
- wednesday → sunday: 1 articles
- thursday → saturday: 1 articles
- thursday → sunday: 1 articles
- tuesday → tuesday: 1 articles
- tuesday → thursday: 1 articles

**Category retag summary:**
- news → design: 6 articles
- news → homestead: 5 articles
- news → ai-tech: 3 articles
- news → outdoors: 3 articles
...
# Scoring Prompt for RSS Relevance Calibration

- **Prioritize practical autonomy & self-sufficiency**: Home automation, smart home accessibility (plain English configs), DIY tools, homesteading infrastructure (water collection, outdoor cooking), and tech that enables independence score highest when framed as "how-to" or capability-focused rather than product reviews.

- **Local + community impact > general news**: Williams Lake Tribune articles about 4H, First Nations cultural projects, and local non-profits rank as exemplars. Boost BC/Canada-specific news about agriculture, community grants, and Indigenous initiatives; deprioritize generic national politics and celebrity culture.

- **AI/tech only when tied to adoption, telemetry, or real work impact**: GitHub blog posts about infrastructure and ROI metrics score high; generic AI news, product rumors, and smartphone launches score low. Avoid speculative AI hype; favor implementation stories and practical tools.

- **Science & climate require systems-level insight**: Articles about PFAS microplastics, geophysics, hidden infrastructure threats, and climate-agriculture intersections (agrivoltaics, soil science) rank high. Avoid listicles ("7 TV shows"), celebrity health gossip, and surface-level wellness tips.

- **Design & homestead articles should emphasize functional renovation, not aesthetics alone**: Bathroom value-adds, self-build mistakes, patterned flooring, and garden planning score higher than pure interior inspiration or celebrity homes. Retag design/homestead content miscategorized as "news."

- **Outdoor content = function + accessibility**: E-bikes, trail runner training tools, and fishing gear framed as "core" functionality score higher than fashion or lifestyle. Avoid recreational entertainment without practical application.

- **Consistently reassign high-value articles to Sunday**: Science, climate, health research, and investigative journalism (NPS sign removal, volcanic threats) migrate to Sunday; retag wellness/nature writing; keep Monday-Wednesday for work-relevant content (AI, GitHub, automation).

- **Downweight entertainment, celebrity, and lifestyle gossip hard**: TV reviews, celebrity health updates, game delays, watch launches, and luxury car culture score consistently low. Filter aggressively unless framed as cultural criticism (Jill Lepore) or systemic analysis (Steam economy).

- **Retag aggressively when source suggests wrong category**: Gadget reviews mistagged as "news," music criticism as "scifi," household items as "news." Use source domain + framing to correct category before scoring relevance.

- **Favor long-form investigation & policy over quick takes**: Articles with >67 Q/R scores cluster around substantive reporting (NPS removal, settlement agreements, health

---
## Feedback Archive Run — 2026-09-06 16:14 UTC
...
**Live files remaining:** 77
**URL ledger:** 1315 URLs (+104 new, −0 pruned)

---
## Feedback Training Run — 2026-08-30 17:16 UTC

**Files processed:** 2026-08-01.json, 2026-08-02.json, 2026-08-03.json, 2026-08-04.json, 2026-08-05.json, 2026-08-06.json, 2026-08-07.json, 2026-08-08.json, 2026-08-09.json, 2026-08-10.json, 2026-08-11.json, 2026-08-12.json, 2026-08-13.json, 2026-08-14.json, 2026-08-15.json, 2026-08-16.json, 2026-08-17.json, 2026-08-18.json, 2026-08-19.json, 2026-08-20.json, 2026-08-21.json, 2026-08-22.json, 2026-08-24.json, 2026-08-25.json, 2026-08-26.json, 2026-08-28.json
**Ratings:** 10 Exemplars, 42 Good, 73 Interesting, 271 Bad, 40 reassigned to day(s), 33 recategorized
**Status:** ✅ config/feedback_examples.txt updated

**Top liked sources:** ScienceAlert (4), Engadget (3), Al Jazeera English (2), Business Insider (2), Outside Online (2)
**Top disliked sources:** Rolling Stone (18), Edge (GamesRadar) (14), Ideal Home (Country Homes & Interiors) (13), Outside Online (11), WIRED (10)
**Categories liked:** news (13), ai-tech (7), wellness (5), science (4), climate (3), homestead (3), homelab (2), local (2), scifi (1), design (1), outdoors (1)
**Categories disliked:** news (235), wellness (20), ai-tech (6), design (4), homelab (2), local (1), science (1), outdoors (1), scifi (1)
...
- tuesday → thursday: 1 articles
- wednesday → sunday: 2 articles
- wednesday → wednesday: 1 articles
- wednesday → friday: 1 articles
- thursday → sunday: 4 articles
- thursday → wednesday: 2 articles
...
# Scoring Calibration Bullets for Curator Feed

**Core Topic Signals (Exemplars = Highest Priority)**
- **Practical DIY + emerging tech**: 3D printing, Home Assistant, smart home automation, repurposing existing hardware (e.g., making old iPads/bikes useful) score highest. Favor hands-on, implementable projects over passive consumption.
- **AI adoption & telemetry**: GitHub ecosystem, enterprise AI dashboards, and measurable ROI/impact of AI tools are exemplar-level. De-prioritize generic AI hype or product launches.
- **Local + community infrastructure**: Williams Lake Tribune coverage of 4-H, Indigenous projects, and local civic initiatives score high. Prioritize regional BC/Cariboo content with community service angles over generic "local news."
- **Applied science with real-world impact**: Microplastics, cholesterol treatments removing PFAS, fault detection—science that affects daily life or policy ranks above pure discovery.

**Under-Represented Topics Worth Boosting**
- **Homestead + agriculture**: Farm economics, cattle ranching policy, agricultural infrastructure (e.g., pizza ovens, lawn care) appear in Interesting/Good but are sparse. Boost articles on food systems, farming tech, and rural land use.
- **Climate + regional environmental challenges**: Wildfires, EV infrastructure, conservation. Many reassigned to multiple days, indicating strong interest.
- **Wellness with agency**: Longevity, health monitoring, mental load—but avoid generic "how-to" wellness fluff (e.g., "How to Stop Procrastinating").

**Category Re-tagging Pattern** *(Curator consistently corrects curator's own categorization)*
- **AI-tech is broader than assumed**: Includes hardware (headphones, iPads, assistants), EV records, and even consumer tech news. Don't limit to software/tools.
- **News → Homelab/Homestead/Outdoors**: Generic "news" tags often mask maker/DIY/practical lifestyle content. Re-categorize articles about upgrading homes, outdoor gear, or hands-on projects.
- **Wellness is underused**: Mental health, fitness, and health-monitoring articles mislabeled as "news." Recategorize opinion/lifestyle wellness pieces accordingly.

**Day Reassignment Pattern**
- **Weekend podcasts (Friday–Sunday) favor climate, science, wellness, and community news**—articles reassigned heavily to these days. Weekday episodes skew toward homelab, AI-tech, and work-relevant content.
- **Cariboo Signals (local podcast) is sacred** (score 86)—never filter or dep

---
## Feedback Archive Run — 2026-08-30 17:16 UTC
...
**Topic/framing lessons:** n/a (no batch archived)
**Raw bytes freed:** 0.0 KB
**Live files remaining:** 70
**URL ledger:** 1211 URLs (+59 new, −0 pruned)
...
**Ratings:** 156 Good, 0 Interesting, 200 Bad, 134 reassigned to day(s)
**Status:** ✅ config/feedback_examples.txt updated

**Top liked sources:** Williams Lake Tribune (13), TechRadar (8), My Cariboo Now (8), BC Gov News (7), Engadget (6)
**Top disliked sources:** Al Jazeera English (16), Business Insider (11), NYT Top Stories (11), Pique Newsmagazine (9), Boing Boing (8)
**Categories liked:** news (113), local (23), wellness (9), ai-tech (8), climate (3)
**Categories disliked:** news (170), wellness (12), ai-tech (11), local (3), podcast-sunday (2), podcast-friday (1), scifi (1)
...
- wednesday → monday: 2 articles
- wednesday → thursday: 2 articles
- wednesday → wednesday: 2 articles
- friday → wednesday: 8 articles
- friday → sunday: 7 articles
- friday → thursday: 5 articles
- friday → saturday: 4 articles
...
- **Favor constructive solutions & resilience narratives**: Articles about community action, system improvements, and human-centered problem-solving score high (e.g., child/youth system fixes, social capital, L&D innovation). De-weight crisis-only coverage without forward momentum.

- **Local/regional relevance heavily weighted**: Williams Lake and B.C./Cariboo region stories consistently receive 85–90 scores despite lower query/ranking metrics (Q21 R21). Prioritize hyperlocal sources and community impact angles over national outlets on local topics.

- **Environmental/climate stories resonate when tied to tangible impacts**: Wildlife/habitat loss (birds in tailings), wildfire alerts, and resource management get strong scores. Avoid abstract climate discourse without specific regional or species-level detail.

- **Human-interest + expertise framing outperforms celebrity/scandal framing**: Personal transformation narratives (pilgrimage nurses, wind phone) and credentialed expert voices (Daniel Aldrich on resilience, press freedom journalism) score high; gossip/crime tabloid angles (Ghislaine Maxwell, celebrity feuds) score low despite viral potential.

- **AI/tech coverage: critical analysis > hype**: Articles questioning AI ROI, data risks, and infrastructure limits (Gary Marcus, data centre moratorium, GPU accessibility caveats) score 70–80. Avoid uncritical product announcements and corporate AI claims (Pinterest AI app, enterprise AI adoption fluff).

- **De-prioritize US politics, health scandal, and international conflict coverage**: Articles on elections, health/crime trials, geopolitical violence, and military incidents consistently appear in Bad Fit despite high query scores. These may rank well algorithmically but don't match curator preferences.

- **Friday–Saturday slot attraction for environmental/community action**: Wildfire, habitat, and local impact stories reassigned to Fri/Sat suggest podcast day thematic clustering. Boost relevance for weekend-positioned environmental narratives.

- **Monday reserved for cultural/creative/gentle-interest content**: Music, festivals, literary excerpts, and human-centered experiential pieces moved to Monday. Flag uplifting or artistic framing for early-week slots.

- **Source diversity matters less than framing**: High-scoring articles span niche outlets (Resilience.org, The Narwhal, APTN) and mainstream (Global News, Quartz). Quality of insight trumps publication tier.

- **Avoid sensationalism in headline/framing**: Dramatic rescue narratives (plane crashes, school fires) score 78–83 in Bad Fit despite high algorithmic ranking. Prefer measured, solutions-oriented framing over urgency-
