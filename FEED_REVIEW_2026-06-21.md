...
|------|----------|-----------|-------------|-------|------------|
| 🤖 AI/ML & Tech | 80 | 🔴 21.1 | 0–80 | 64 | TechRadar (10) |
| 🌍 Climate & Energy | 24 | 🔴 10.5 | 0–51 | 20 | ScienceDaily (4) |
| 🏠 Homelab & DIY | 11 | 🔴 14.3 | 0–76 | 7 | XDA Developers (3) |
| 🏔️ Williams Lake Local | 30 | 🟢 78.2 | 22–90 | 22 | Williams Lake Tribune (15) |
| 📰 General News | 323 | 🟡 61.2 | 20–87 | 256 | Al Jazeera English (43) |
| 🔬 Science | 0 | 🔴 0.0 | 0–0 | 0 | — (0) |
| 🚀 Sci-Fi & Culture | 12 | 🔴 19.9 | 2–83 | 9 | Boing Boing (3) |
| 🌿 Health & Wellness | 66 | 🔴 38.5 | 6–75 | 56 | STAT News (11) |
...
- **Articles**: 323 (323 scored)
- **Score**: avg 61.2 | min 20 | max 87
- **Stale** (>48h): 256
- **Avg age**: 76.5h
...
- 🕐 **🤖 AI/ML & Tech** has 64 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🕐 **🏔️ Williams Lake Local** has 22 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🕐 **📰 General News** has 256 articles older than 48h — verify `feed_retention_days` in `config/limits.json` and that the workflow ran recently.
...
- 🗑️ 12 article(s) should be removed (`off-topic` ×4, `clickbait` ×2, `deals` ×2, `advice` ×2, `celebrity` ×2) — add matching keywords to `config/filters.json` blocked_keywords to prevent recurrence.

---

_Report generated by `score_scrub_report.py` · 8 feeds · 546 articles · 2026-06-21 15:18 UTC_
